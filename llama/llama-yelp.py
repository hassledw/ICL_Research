...
def run_zeroshot_yelp_data_prompt_1():
    ### RUN ON YELP DATASET
    ...
    df.to_csv("/home/grads/hassledw/ICL_Research/UDR_yelp_results/UDR-yelp-zeroshot-llama-1.csv")

def run_fewshot_yelp_data_prompt_1():
    ### RUN ON YELP DATASET
    X_train, y_train, X_test, y_test, X_debug, y_debug = create_data_arrays(datasetname="KaiLv/UDR_Yelp")
    ...
    df.to_csv("/home/grads/hassledw/ICL_Research/UDR_yelp_results/UDR-yelp-fewshot-llama-1.csv")

def run_zeroshot_yelp_data_prompt_2():
    ### RUN ON YELP DATASET
    X_train, y_train, X_test, y_test, X_debug, y_debug = create_data_arrays(datasetname="KaiLv/UDR_Yelp")
    ...
    df.to_csv("/home/grads/hassledw/ICL_Research/UDR_yelp_results/UDR-yelp-zeroshot-llama-2.csv")

def run_fewshot_yelp_data_prompt_2():
    ### RUN ON YELP DATASET
    X_train, y_train, X_test, y_test, X_debug, y_debug = create_data_arrays(datasetname="KaiLv/UDR_Yelp")
    ...
    df.to_csv("/home/grads/hassledw/ICL_Research/UDR_yelp_results/UDR-yelp-fewshot-llama-2.csv")

def run_zeroshot_yelp_data_prompt_3():
        ### RUN ON YELP DATASET
    X_train, y_train, X_test, y_test, X_debug, y_debug = create_data_arrays(datasetname="KaiLv/UDR_Yelp")
    ...
    df.to_csv("/home/grads/hassledw/ICL_Research/UDR_yelp_results/UDR-yelp-zeroshot-llama-3.csv")

def run_fewshot_yelp_data_prompt_3():
    ### RUN ON YELP DATASET
    X_train, y_train, X_test, y_test, X_debug, y_debug = create_data_arrays(datasetname="KaiLv/UDR_Yelp")
    ...
    df.to_csv("/home/grads/hassledw/ICL_Research/UDR_yelp_results/UDR-yelp-fewshot-llama-3.csv")
